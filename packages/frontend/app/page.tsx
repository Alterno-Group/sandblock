      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div className="bg-card rounded-lg p-4 sm:p-6 border border-card-border transition-all">
            ...
            <Tooltip
              text={`$${totalRaised.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
            >
          ...
          <div className="bg-card rounded-lg p-4 sm:p-6 border border-card-border transition-all">
            ...
            <Tooltip
              text={`$${totalGoal.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
            >
              <div className="text-2xl sm:text-3xl font-bold mb-1 text-foreground">
                $
                {totalGoal >= 1000000
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs sm:text-sm text-muted-foreground space-y-1">
                <p className="flex justify-between">
                  <span>&lt; $2,000:</span> <span className="font-semibold text-foreground">5% APY</span>
                </p>
                <p className="flex justify-between">
                  <span>$2K - $20K:</span> <span className="font-semibold text-foreground">7% APY</span>
                </p>
                <p className="flex justify-between">
                  <span>&gt; $20,000:</span> <span className="font-semibold text-foreground">9% APY</span>
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                Earn interest <span className="font-semibold text-foreground">every week</span> after the project
                construction is completed. Interest is calculated based on your investment tier and can be claimed at
                any time.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                Starting <span className="font-semibold text-foreground">2 years</span> after funding completion,
                receive <span className="font-semibold text-foreground">20% of your principal annually</span> until
